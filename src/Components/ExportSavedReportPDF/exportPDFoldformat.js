      ...
      <Document>
        ...
        >
          ...
          <View style={styles.reportTitleDiv}>
            ...
            <Text style={{ position: "absolute", top: 263, left: 100, fontSize: 14, color: "#004d40" }}>
    {selectedOrganization.label}
  </Text>
            <Text style={{ position: "absolute", top: 307, left: 100, fontSize: 14, color: "#004d40" }}>
    {reportType === "HSE" ? "HSE Audit" : "Electrical Audit"}
  </Text>
  <Text style={{ position: "absolute", top: 354, left: 100, fontSize: 14, color: "#004d40" }}>
    {selectedSite.label}
  </Text>
  <Text style={{ position: "absolute", top: 398, left: 80, fontSize: 14, color: "#004d40" }}>
    {startDate.getTime() === endDate.getTime()
        ...
        {introduction ? <Page size="A4" style={styles.page} orientation="landscape">
          {/* <Text
            style={styles.footer}
            render={({ pageNumber, totalPages }) =>
              `    ${selectedDateTime.split("-").reverse().join("-")}                                                      Prepared by Momentum                                                           ${pageNumber}`
      ...
      <View style={{ flexDirection: "row", marginHorizontal: 40 }}>
        ...
        >
          <Text style={{ fontSize: 24, fontWeight: "bold" }}>
            {`${Math.floor((cumulativeScore / 10) * 100)}%`}
          </Text>
        </View>
  ...
  {renderRiskLevelTable()}
    ...
    {reportType === "HSE" ?
        ...
        {/* <Page size="A4" style={styles.page} orientation="landscape">
          ...
          <Text style={[styles.pageContent, styles.heading]}>
            {reportType === "HSE" ? "4. Critical Observations" : "4. Critical Observations"}
          </Text>
          <Text>{'\n'}</Text>
  ...
  <View style={[ styles.pageContent ]}>
    <Text style={[styles.pageContent, { color: 'gray' }]}>
      No critical observations found.
        ...
        {reportType === "HSE" ? <Page size="A4" style={styles.page} orientation="landscape">
          {/* <Text
            style={styles.footer}
            render={({ pageNumber, totalPages }) =>
              `    ${selectedDateTime.split("-").reverse().join("-")}                                                      Prepared by Momentum                                                           ${pageNumber}`
          ...
          <View style={customStyles.tableRow}>
            ...
            <Text style={customStyles.tableCellCumulative}>
              {cumulativeScore}
                  ...
                  <Text style={{ color: "#307268",marginLeft:"50px" }}>Overall Score - <Text style={{ color: "#efc71d",fontSize: 15 }}>{((cumulativeScore / 10) * 100).toFixed(2)}%</Text></Text>
     <Image src={chartImageElectrical} style={{ width: 350, height: 150, marginLeft:"100px"}} />
      </View>
    );
  };
          ...
          <View key={index}>
            ...
            <View style={styles.table}>
              <View style={styles.tableRow}>
                ...
                <Text style={styles.tableCellHeader}>system_implementation</Text>
                <Text style={styles.tableCellHeader}>compliance_check</Text>
              ...
              {groupedObservations[tableType].map((observation, index) => (
                <View key={index} style={styles.tableRow}>
                  ...
                  {reportType === "HSE" ? (
                   ...
                   <Text style={styles.tableCell}>
                    {observation.system_implementation ? observation.system_implementation : "N/A"}
                  </Text>
                   <Text style={styles.tableCell}>
                    {observation.compliance_check ? observation.compliance_check : "N/A"}
                  </Text>
...
const styles = {
  ...
  height: 595,     // match A4 landscape height (≈595 pt in React-PDF)
  position: "relative",
